...
data.forEach(p => {
  ...
  if (!p.imgUrl || p.imgUrl === '' || p.imgUrl.includes('placeholder')) p.imgUrl = '/coming-soon.png';
});
fs.writeFileSync('c:\\Projects\\SGtradingcard\\data\\products.json', JSON.stringify(data, null, 2));
console.log('Database synced and patched successfully.');
